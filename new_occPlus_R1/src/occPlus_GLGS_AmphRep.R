...
saveRDS(fitmodel3, "occuPlus_Herps_d3_9June2025.rda")


# Investigate Model Outputs -----------------------------------------------

fitmodel <- readRDS("occuPlus_Herps_d3_9June2025.rda")
...
# these are the outputs for scores, factors, ordination 
U_output0 <- 
