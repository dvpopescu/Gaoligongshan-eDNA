...
fitmodel2  <- runOccPlus(data1,
                         d = 2,
                         occCovariates = c(),
                         ordCovariates = c("annual_precipitation", "mean_temperature",
...
saveRDS(fitmodel2, "occuPlus_Aves_d2_9June2025.rda")

# Investigate Model Outputs -----------------------------------------------

fitmodel <- readRDS("occuPlus_Aves_d2_9June2025.rda")
...
ggsave(here("outputs", "occPlus_outputs_Viorel covs", "Ave_outputs_20241018_2factors", "occupancy_occPlus_Ave_20241018_2factors.jpeg"), width = 8,
       height = 12,
       units = "in",
       dpi = 300)

write.csv(occ, here("outputs", "occPlus_outputs_Viorel covs", "Ave_outputs_20241018_2factors", "occupancy_occPlus_Ave_20241018_2factors.csv"))
...
write.csv(occ, here("outputs", "occPlus_outputs_Viorel covs", "Ave_outputs_20241018_2factors", "occupancybysite_occPlus_Ave_20241018_2factors.csv"))
...
# 1 stage probabilities output
{
  ...
  ggsave(here("outputs", "occPlus_outputs_Viorel covs", "Ave_outputs_20241018_2factors", "1stagerate_Ave_20241018_2factors.jpeg"), width = 8,
         height = 12,
         units = "in",
         dpi = 300)
...
write.csv(data_plot, here("outputs", "occPlus_outputs_Viorel covs", "Ave_outputs_20241018_2factors", "1stagerate_occPlus_Ave_20241018_2factors.csv"))
...
# 2 stage probabilities output
{
  ...
  ggsave(here("outputs", "occPlus_outputs_Viorel covs", "Ave_outputs_20241018_2factors", "2stagerate_Ave_20241018_2factors.jpeg"), width = 8,
         height = 12,
         units = "in",
         dpi = 300)
...
write.csv(data_plot, here("outputs", "occPlus_outputs_Viorel covs", "Ave_outputs_20241018_2factors", "2stagerate_occPlus_Ave_20241018_2factors.csv"))
...
# Factor 1
data_plot1 <- data_plot[1:(nrow(data_plot)/2),]
...
ggsave(here("outputs", "occPlus_outputs_Viorel covs", "Ave_outputs_20241018_2factors", "factor1_Ave_20241018_2factors.jpeg"), width = 5,
       height = 2,
       units = "in",
       dpi = 300)

# Factor 2
data_plot2 <- data_plot[((nrow(data_plot)/2)+1):(nrow(data_plot)/2+9),]
...
ggsave(here("outputs", "occPlus_outputs_Viorel covs", "Ave_outputs_20241018_2factors", "factor2_Ave_20241018_2factors.jpeg"), width = 5,
       height = 2,
       units = "in",
       dpi = 300)
...
ggsave(here("outputs", "occPlus_outputs_Viorel covs", "Ave_outputs_20241018_2factors", "factor1scores_Ave_20241018_2factors.jpeg"), width = 8,
       height = 10,
       units = "in",
       dpi = 300)
...
ggsave(here("outputs", "occPlus_outputs_Viorel covs", "Ave_outputs_20241018_2factors", "factor1scores_Ave_20241018_3factors_sorted.jpeg"), width = 5,
       height = 6,
       units = "in",
       dpi = 300)
...
ggsave(here("outputs", "occPlus_outputs_Viorel covs", "Ave_outputs_20241018_2factors", "factor2scores_Ave_20241018_2factors.jpeg"), width = 8,
       height = 10,
       units = "in",
       dpi = 300)
site_info <- data$info %>% select(Site, latitude, streamOrigin, river, altitude) %>% mutate(site = Site) %>% select(-Site)
...
ggsave(here("outputs", "occPlus_outputs_Viorel covs", "Ave_outputs_20241018_2factors", "factor2scores_Ave_20241018_3factors_sorted.jpeg"), width = 5,
       height = 6,
       units = "in",
       dpi = 300)
...
factorscores <- as.data.frame(cbind(data_plot1, data_plot2))[,-c(9,11,12)]
...
ggsave(here("outputs", "occPlus_outputs_Viorel covs", "Ave_outputs_20241018_2factors", "factorscores12_Ave_20241018_byRegion.jpeg"), width = 8,
       height = 6,
       units = "in",
       dpi = 300)
ggsave(here("outputs", "occPlus_outputs_Viorel covs", "Ave_outputs_20241018_2factors", "factorscores12_Ave_20241018_bystreamOrigin.jpeg"), width = 8,
       height = 6,
       units = "in",
       dpi = 300)
...
factor1 <- samples_subset[,seq(1,ncol(samples_subset),2)]
...
ggsave(here("outputs", "occPlus_outputs_Viorel covs", "Ave_outputs_20241018_2factors", "factor1loadings_Ave_20241018_2factors.jpeg"), width = 6,
       height = 9,
       units = "in",
       dpi = 300)
...
factor2 <- samples_subset[,seq(2,ncol(samples_subset),2)]
...
ggsave(here("outputs", "occPlus_outputs_Viorel covs", "Ave_outputs_20241018_2factors", "factor2loadings_Ave_20241018_2factors.jpeg"), width = 6,
       height = 9,
       units = "in",
       dpi = 300)
...
spp_list <- spp_list %>% mutate(ORDER = str_extract(otuID, "(?<=_)[^_]+(?=_)")) %>% 
  filter(class == "Aves") %>% select(species, ORDER, IUCN)

data_plot1 <- left_join(data_plot1, spp_list, by = "species")

IUCN_order <- c("VU", "NT", "LC", "domestic")
IUCN_colors <- c("VU" = "orange", "NT" = "dodgerblue", 
                 "LC" = "mediumseagreen", "domestic" = "black")
order_labels <- c(
  "Accipitriformes" = "AC",
  "Anseriformes" = "AN",
  "Apodiformes" = "AP",
...
ggsave(here("outputs", "occPlus_outputs_Viorel covs", "Ave_outputs_20241018_2factors", "factor1&2loadings_Ave_20241018_2factors_sorted.jpeg"), width = 6,
       height = 12,
       units = "in",
       dpi = 300)
...
ggsave(here("outputs", "occPlus_outputs_Viorel covs", "Ave_outputs_20241018_2factors", "factorloadings_Ave_20241018_2factors.jpeg"), width = 8,
       height = 5,
       units = "in",
       dpi = 300)
...
ggplot(effects_long_BL, aes(x = variable, ymin = lci, ymax = uci)) +
  ...
  scale_y_continuous(breaks = seq(-15, 2, 5), limits = c(-15.4, 4))

ggsave(here("outputs", "occPlus_outputs_Viorel covs", "Ave_outputs_20241018_2factors", "occPlus_Covariates_Ave_20241018.jpeg"), width = 5,
       height = 2,
       units = "in",
       dpi = 300)
...
write.csv(effects_perSP_BL, here("outputs","occPlus_outputs_Viorel covs","Ave_outputs_20241018_2factors","envCov_perSP_table_occPlus_Ave.csv"))


save(list = ls(), file = here("data","Rdata files","occPlus_Ave_20241018_2factors_Vioreldata.Rdata"))
