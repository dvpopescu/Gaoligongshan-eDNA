...
comparison <- loo_compare(loo2, loo3, loo4)
print(comparison)


saveRDS(fitmodel4, "occuPlus_Mammals_d4_9June2025.rda")


# Investigate Model Outputs -----------------------------------------------

fitmodel <- readRDS("occuPlus_Mammals_d4_9June2025.rda")
...
nsites <- length(unique(data1$info$Site))
nspecies <- ncol(data1$OTU)
...
for (i in 1:nsites) {
  for (iter in 1:niter) {
    occProbs_output[iter,i,] <-  logistic(
      fitmodel$X_psi[i,] %*% beta_psi_output[iter,,] + 
...
ggsave(here("outputs", "occPlus_outputs_Viorel covs", "Mammal_outputs_20241018_4factors", "occupancy_occPlus_Mammal_20241018_4factors.jpeg"), width = 8,
       height = 12,
       units = "in",
       dpi = 300)

write.csv(occ, here("outputs", "occPlus_outputs_Viorel covs", "Mammal_outputs_20241018_4factors", "occupancy_occPlus_Mammal_20241018_4factors.csv"))
...
write.csv(occ, here("outputs", "occPlus_outputs_Viorel covs", "Mammal_outputs_20241018_4factors", "occupancybysite_occPlus_Mammal_20241018_4factors.csv"))
...
# 1 stage probabilities output
{
  ...
  ggsave(here("outputs", "occPlus_outputs_Viorel covs", "Mammal_outputs_20241018_4factors", "1stagerate_Mammal_20241018_4factors.jpeg"), width = 8,
         height = 12,
         units = "in",
         dpi = 300)
...
write.csv(data_plot, here("outputs", "occPlus_outputs_Viorel covs", "Mammal_outputs_20241018_4factors", "1stagerate_occPlus_Mammal_20241018_4factors.csv"))
...
# 2 stage probabilities output
{
  ...
  ggsave(here("outputs", "occPlus_outputs_Viorel covs", "Mammal_outputs_20241018_4factors", "2stagerate_Mammal_20241018_4factors.jpeg"), width = 8,
         height = 12,
         units = "in",
         dpi = 300)
...
write.csv(data_plot, here("outputs", "occPlus_outputs_Viorel covs", "Mammal_outputs_20241018_4factors", "2stagerate_occPlus_Mammal_20241018_4factors.csv"))
...
# Factor 1
data_plot1 <- data_plot[1:(nrow(data_plot)/4),]
...
ggsave(here("outputs", "occPlus_outputs_Viorel covs", "Mammal_outputs_20241018_4factors", "factor1_Mammal_20241018_4factors.jpeg"), width = 5,
       height = 2,
       units = "in",
       dpi = 300)

# Factor 2
data_plot2 <- data_plot[((nrow(data_plot)/4)+1):(nrow(data_plot)/4+9),]
...
ggsave(here("outputs", "occPlus_outputs_Viorel covs", "Mammal_outputs_20241018_4factors", "factor2_Mammal_20241018_4factors.jpeg"), width = 5,
       height = 2,
       units = "in",
       dpi = 300)

# Factor 3
data_plot3 <- data_plot[((nrow(data_plot)/4)+10):(nrow(data_plot)/4+18),]
...
ggsave(here("outputs", "occPlus_outputs_Viorel covs", "Mammal_outputs_20241018_4factors", "factor3_Mammal_20241018_4factors.jpeg"), width = 5,
       height = 2,
       units = "in",
       dpi = 300)

# Factor 4
data_plot4 <- data_plot[((nrow(data_plot)/4)+19):(nrow(data_plot)/4+27),]
...
ggsave(here("outputs", "occPlus_outputs_Viorel covs", "Mammal_outputs_20241018_4factors", "factor4_Mammal_20241018_4factors.jpeg"), width = 5,
       height = 2,
       units = "in",
       dpi = 300)
...
ggsave(here("outputs", "occPlus_outputs_Viorel covs", "Mammal_outputs_20241018_4factors", "factor1scores_Mammal_20241018_4factors.jpeg"), width = 8,
       height = 10,
       units = "in",
       dpi = 300)
...
ggsave(here("outputs", "occPlus_outputs_Viorel covs", "Mammal_outputs_20241018_4factors", "factor1scores_Mammal_20241018_4factors_sorted.jpeg"), width = 5,
       height = 10,
       units = "in",
       dpi = 300)
...
ggsave(here("outputs", "occPlus_outputs_Viorel covs", "Mammal_outputs_20241018_4factors", "factor2scores_Mammal_20241018_4factors.jpeg"), width = 8,
       height = 10,
       units = "in",
       dpi = 300)
site_info <- data$info %>% select(Site, latitude, streamOrigin, river, altitude) %>% mutate(site = Site) %>% select(-Site)
...
ggplot(data_plot2, aes(
  ...
  facet_grid(rows = vars(Regional_Division), scales = "free_y", space = "free") +
  geom_hline(yintercept = 0, linetype = "dashed", color = "black")
ggsave(here("outputs", "occPlus_outputs_Viorel covs", "Mammal_outputs_20241018_4factors", "factor2scores_Mammal_20241018_4factors_sorted.jpeg"), width = 5,
       height = 10,
       units = "in",
       dpi = 300)
...
ggsave(here("outputs", "occPlus_outputs_Viorel covs", "Mammal_outputs_20241018_4factors", "factor3scores_Mammal_20241018_4factors.jpeg"), width = 8,
       height = 10,
       units = "in",
       dpi = 300)
...
data_plot4 <- left_join(data_plot4, zones, by = 'site')
...
ggsave(here("outputs", "occPlus_outputs_Viorel covs", "Mammal_outputs_20241018_4factors", "factor4scores_Mammal_20241018_4factors.jpeg"), width = 8,
       height = 10,
       units = "in",
       dpi = 300)
...
factorscores <- as.data.frame(cbind(data_plot1, data_plot2, data_plot3, data_plot4))[,-c(9,11,12,15,17,18,21,23,24)]
...
ggsave(here("outputs", "occPlus_outputs_Viorel covs", "Mammal_outputs_20241018_4factors", "factorscores12_Mammal_20241018_byRegion.jpeg"), width = 8,
       height = 6,
       units = "in",
       dpi = 300)
ggsave(here("outputs", "occPlus_outputs_Viorel covs", "Mammal_outputs_20241018_4factors", "factorscores12_Mammal_20241018_bystreamOrigin.jpeg"), width = 8,
       height = 6,
       units = "in",
       dpi = 300)
...
ggsave(here("outputs", "occPlus_outputs_Viorel covs", "Mammal_outputs_20241018_4factors", "factorscores13_Mammal_20241018_byRegion.jpeg"), width = 8,
       height = 6,
       units = "in",
       dpi = 300)
ggsave(here("outputs", "occPlus_outputs_Viorel covs", "Mammal_outputs_20241018_4factors", "factorscores13_Mammal_20241018_bystreamOrigin.jpeg"), width = 8,
       height = 6,
       units = "in",
       dpi = 300)

# F1 ~ F4
ggplot(factorscores, aes(F1.mean, F4.mean, col=Regional_Division)) +
  #ggplot(factorscores, aes(F1.mean, F4.mean, col=streamOrigin)) +
  geom_point() +
  geom_label_repel(aes(label = site),
                   box.padding   = 0.35, 
                   point.padding = 0.5,
                   segment.color = 'grey50') +
  geom_errorbar(aes(xmin = F1.lower, xmax = F1.upper)) +
  geom_errorbar(aes(ymin = F4.lower, ymax = F4.upper)) + 
  stat_ellipse(level = 0.9, type = "norm") +
  xlab ("Factor 1 Scores") +
  ylab ("Factor 4 Scores") +
  theme_bw() +
  theme(
    legend.text = element_text(size = 16),
    axis.text.x = element_text(size = 16),
...
ggsave(here("outputs", "occPlus_outputs_Viorel covs", "Mammal_outputs_20241018_4factors", "factorscores14_Mammal_20241018_byRegion.jpeg"), width = 8,
       height = 6,
       units = "in",
       dpi = 300)
ggsave(here("outputs", "occPlus_outputs_Viorel covs", "Mammal_outputs_20241018_4factors", "factorscores14_Mammal_20241018_bystreamOrigin.jpeg"), width = 8,
       height = 6,
       units = "in",
       dpi = 300)
...
ggsave(here("outputs", "occPlus_outputs_Viorel covs", "Mammal_outputs_20241018_4factors", "factorscores23_Mammal_20241018_byRegion.jpeg"), width = 8,
       height = 6,
       units = "in",
       dpi = 300)
ggsave(here("outputs", "occPlus_outputs_Viorel covs", "Mammal_outputs_20241018_4factors", "factorscores23_Mammal_20241018_bystreamOrigin.jpeg"), width = 8,
       height = 6,
       units = "in",
       dpi = 300)

# F2 ~ F4
ggplot(factorscores, aes(F2.mean, F4.mean, col=Regional_Division)) +
  #ggplot(factorscores, aes(F2.mean, F4.mean, col=streamOrigin)) +
  geom_point() +
  geom_label_repel(aes(label = site),
                   box.padding   = 0.35, 
                   point.padding = 0.5,
...
ggsave(here("outputs", "occPlus_outputs_Viorel covs", "Mammal_outputs_20241018_4factors", "factorscores24_Mammal_20241018_byRegion.jpeg"), width = 8,
       height = 6,
       units = "in",
       dpi = 300)
ggsave(here("outputs", "occPlus_outputs_Viorel covs", "Mammal_outputs_20241018_4factors", "factorscores24_Mammal_20241018_bystreamOrigin.jpeg"), width = 8,
       height = 6,
       units = "in",
       dpi = 300)

# F3 ~ F4
ggplot(factorscores, aes(F3.mean, F4.mean, col=Regional_Division)) +
  #ggplot(factorscores, aes(F3.mean, F4.mean, col=streamOrigin)) +
  geom_point() +
  geom_label_repel(aes(label = site),
                   box.padding   = 0.35, 
                   point.padding = 0.5,
                   segment.color = 'grey50') +
  geom_errorbar(aes(xmin = F3.lower, xmax = F3.upper)) +
  geom_errorbar(aes(ymin = F4.lower, ymax = F4.upper)) + 
  stat_ellipse(level = 0.9, type = "norm") +
  xlab ("Factor 3 Scores") +
  ylab ("Factor 4 Scores") +
  theme_bw() +
  theme(
    legend.text = element_text(size = 16),
...
ggsave(here("outputs", "occPlus_outputs_Viorel covs", "Mammal_outputs_20241018_4factors", "factorscores34_Mammal_20241018_byRegion.jpeg"), width = 8,
       height = 6,
       units = "in",
       dpi = 300)
ggsave(here("outputs", "occPlus_outputs_Viorel covs", "Mammal_outputs_20241018_4factors", "factorscores34_Mammal_20241018_bystreamOrigin.jpeg"), width = 8,
       height = 6,
       units = "in",
       dpi = 300)
...
png(here("outputs", "occPlus_outputs_Viorel covs", "Mammal_outputs_20241018_4factors", "factorscores123_Mammal_20241018_4factors_byRegion.jpeg"), width = 800, height = 800)
png(here("outputs", "occPlus_outputs_Viorel covs", "Mammal_outputs_20241018_4factors", "factorscores123_Mammal_20241018_4factors_bystreamOrigin.jpeg"), width = 800, height = 800)
...
# Open a PNG file to save the plot
png(here("outputs", "occPlus_outputs_Viorel covs", "Mammal_outputs_20241018_4factors", "factorscores124_Mammal_20241018_4factors_byRegion.jpeg"), width = 800, height = 800)
png(here("outputs", "occPlus_outputs_Viorel covs", "Mammal_outputs_20241018_4factors", "factorscores124_Mammal_20241018_4factors_bystreamOrigin.jpeg"), width = 800, height = 800)
...
# Open a PNG file to save the plot
png(here("outputs", "occPlus_outputs_Viorel covs", "Mammal_outputs_20241018_4factors", "factorscores234_Mammal_20241018_4factors_byRegion.jpeg"), width = 800, height = 800)
png(here("outputs", "occPlus_outputs_Viorel covs", "Mammal_outputs_20241018_4factors", "factorscores234_Mammal_20241018_4factors_bystreamOrigin.jpeg"), width = 800, height = 800)
...
# Open a PNG file to save the plot
png(here("outputs", "occPlus_outputs_Viorel covs", "Mammal_outputs_20241018_4factors", "factorscores134_Mammal_20241018_4factors_byRegion.jpeg"), width = 800, height = 800)
png(here("outputs", "occPlus_outputs_Viorel covs", "Mammal_outputs_20241018_4factors", "factorscores134_Mammal_20241018_4factors_bystreamOrigin.jpeg"), width = 800, height = 800)
...
factor1 <- samples_subset[,seq(1,ncol(samples_subset),4)]
...
ggsave(here("outputs", "occPlus_outputs_Viorel covs", "Mammal_outputs_20241018_4factors", "factor1loadings_Mammal_20241018_4factors.jpeg"), width = 6,
       height = 9,
       units = "in",
       dpi = 300)
...
factor2 <- samples_subset[,seq(2,ncol(samples_subset),4)]
...
ggsave(here("outputs", "occPlus_outputs_Viorel covs", "Mammal_outputs_20241018_4factors", "factor2loadings_Mammal_20241018_4factors.jpeg"), width = 6,
       height = 9,
       units = "in",
       dpi = 300)
...
spp_list <- spp_list %>% mutate(ORDER = str_extract(otuID, "(?<=_)[^_]+(?=_)")) %>% 
  filter(class == "Mammalia") %>% select(species, ORDER, IUCN, AdultBodyMass)

data_plot1 <- left_join(data_plot1, spp_list, by = "species") %>% 
  mutate(species = factor(species, levels = species[order(AdultBodyMass)]))

data_plot2 <- left_join(data_plot2, spp_list, by = "species") %>% 
  mutate(species = factor(species, levels = species[order(AdultBodyMass)]))

IUCN_order <- c("EN", "VU", "NT", "LC", "DD", "NA", "domestic")
IUCN_colors <- c("EN" = "red", "VU" = "orange", "NT" = "dodgerblue", 
                 "LC" = "mediumseagreen", "DD" = "grey80", "NA" = "grey60", "domestic" = "black")
order_labels <- c(
  "Carnivora" = "CA",
  "Artiodactyla" = "AR",
  "Perissodactyla" = "PE",
...
dataplot_long <- dataplot_12 %>%
  ...
  mutate(Type = factor(Type, levels = c("F1", "F2")),
         species = factor(species, levels = dataplot_12$species[order(dataplot_12$AdultBodyMass, na.last = TRUE)]))

ggplot(dataplot_long, aes(x = mean, y = reorder(species, AdultBodyMass), color = IUCN)) +
  geom_point(size = 1) +
...
ggsave(here("outputs", "occPlus_outputs_Viorel covs", "Mammal_outputs_20241018_4factors", "factor1&2loadings_Mammal_20241018_4factors_sorted.jpeg"), width = 6,
       height = 12,
       units = "in",
       dpi = 300)
...
factor3 <- samples_subset[,seq(3,ncol(samples_subset),4)]
...
ggsave(here("outputs", "occPlus_outputs_Viorel covs", "Mammal_outputs_20241018_4factors", "factor3loadings_Mammal_20241018_4factors.jpeg"), width = 6,
       height = 9,
       units = "in",
       dpi = 300)
...
factor4 <- samples_subset[,seq(4,ncol(samples_subset),4)]
...
ggsave(here("outputs", "occPlus_outputs_Viorel covs", "Mammal_outputs_20241018_4factors", "factor4loadings_Mammal_20241018_4factors.jpeg"), width = 6,
       height = 9,
       units = "in",
       dpi = 300)
...
factorloadings <- as.data.frame(cbind(data_plot1, data_plot2, data_plot3, data_plot4))[,-c(3, 7, 11)]
...
ggsave(here("outputs", "occPlus_outputs_Viorel covs", "Mammal_outputs_20241018_4factors", "factorloadings12_Mammal_20241018_4factors.jpeg"), width = 8,
       height = 5,
       units = "in",
       dpi = 300)
...
factorloadings <- cbind(factorloadings, spp)
spp_list <- read_tsv(here("data","SP_withBODYSIZE.txt"))
spp_list <- spp_list %>% 
  mutate(IUCN = ifelse(is.na(IUCN), "NA", IUCN)) %>% 
  mutate(IUCN = ifelse(status == "dom" | status == "wild_or_dom", "domestic", IUCN))
...
factorloadings <- left_join(factorloadings, spp_list, by = c("spp" = "species"))
IUCN_order <- c("EN", "VU", "NT", "LC", "DD", "NA", "domestic")
IUCN_colors <- c("EN" = "red", "VU" = "orange", "NT" = "dodgerblue", 
                 "LC" = "mediumseagreen", "DD" = "grey80", "NA" = "grey60", "domestic" = "black")

ggplot(factorloadings, aes(F1.mean, F2.mean, col=ORDER)) +
  geom_point() +
  #geom_errorbar(aes(ymin = F2.lower, ymax = F2.upper)) + 
  #geom_errorbar(aes(xmin = F1.lower, xmax = F1.upper)) +
  xlab ("Factor 1 Loadings") +
...
ggplot(factorloadings, aes(F1.mean, F2.mean, col=IUCN)) +
  geom_point() +
  #geom_errorbar(aes(ymin = F2.lower, ymax = F2.upper)) + 
  #geom_errorbar(aes(xmin = F1.lower, xmax = F1.upper)) +
  scale_color_manual(values = IUCN_colors, 
                     limits = IUCN_order,
                     name = "Status",
                     labels = c("Endangered", "Vulnerable", "Near Threatened", "Least Concern", "Data Deficient", "Not Applicable", "Domestic")) +
  xlab ("Factor 1 Loadings") +
  ylab ("Factor 2 Loadings") +
  theme_bw()
...
ggsave(here("outputs", "occPlus_outputs_Viorel covs", "Mammal_outputs_20241018_4factors", "occPlus_Covariates_Mammal_20241018.jpeg"), width = 5,
       height = 2,
       units = "in",
       dpi = 300)
...
write.csv(effects_perSP_BL, here("outputs","occPlus_outputs_Viorel covs","Mammal_outputs_20241018_4factors","envCov_perSP_table_occPlus_Mammal.csv"))


save(list = ls(), file = here("data","Rdata files","occPlus_Mammal_20241018_4factors_Vioreldata.Rdata"))
