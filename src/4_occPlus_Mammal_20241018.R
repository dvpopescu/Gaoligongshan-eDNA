...
load(here("data", "gaoligongshan_Mammal_data_20240912.rda"))
...
print(comparison)
#   elpd_diff se_diff
# model3(4 factors)    0.0       0.0 
# model4(5 factors)  -29.3      14.9 
# model2(3 factors)  -66.3      18.7 
# model5(6 factors) -113.6      17.9 
# model1(2 factors) -157.9      25.2  
...
for (i in 1:nsites) {
  for (iter in 1:niter) {
    occProbs_output[iter,i,] <-  logistic(
      results$X_psi[i,] %*% beta_psi_output[iter,,] + 
