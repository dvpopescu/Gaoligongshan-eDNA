...
transformed parameters {
  ...
  matrix[n, S] logit_psi =  rep_matrix(beta0_psi', n) + X_psi * beta_psi + U * L;
...
generated quantities {
  ...
  matrix[n,S] log_lik;
  matrix[n,S] log_post_pocc;
  matrix[n,S] log_post_p1mocc;
  ...
  real log_p_yz0;
   ...
   for(s in 1:S){
    ...
    for (i in 1:n) {
      ...
      log_post_pocc[i,s] = log_psi[i, s] +  log_p_yz1;
      log_post_p1mocc[i,s] = log1m_psi[i, s] + log_p_yz0;
