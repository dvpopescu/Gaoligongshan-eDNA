...
spptoremove <- glgs %>% 
  ...
  dplyr::select(!contains(c("Spikein", "Actinopteri", "Teleostei", "Amphibia", "Reptilia", "Mammalia"))) %>% 
  dplyr::select(SampleID, PCR, site, contains("OTU")) %>% 
  rename_with(.cols = starts_with("Aves"), 
...
glgs_sum1 <- glgs %>% 
  ...
  select(!starts_with(c("Spikein", "Actinopteri", "Teleostei", "Amphibia", "Reptilia", "Mammalia"))) |>
...
pdf(here("outputs","msom_outputs_Viorel covs","Ave_outputs_20241018","msom_Ave_beta_traceplot_20241018.pdf"))
plot(out.ms, 'beta', density = TRUE) # Occupancy parameters.
dev.off()
pdf(here("outputs","msom_outputs_Viorel covs","Ave_outputs_20241018","msom_Ave_alpha_traceplot_20241018.pdf"))
...
# save occupancy plot
ggsave(here("outputs","msom_outputs_Viorel covs","Ave_outputs_20241018","occupancy_MSOM_Ave_1kmdata_20241018.jpeg"), 
       width = 8,
       height = 10,
       units = "in",
       dpi = 300)

write.csv(psi_preds, here("outputs","msom_outputs_Viorel covs","Ave_outputs_20241018","occupancy_preds_msom_Ave_20241018.csv"))
...
write.csv(psi.bysite, here("outputs","msom_outputs_Viorel covs","Ave_outputs_20241018","occupancy_bysite_msom_Ave_20241018.csv"))
...
write.csv(p_preds, here("outputs","msom_outputs_Viorel covs","Ave_outputs_20241018","detection_preds_msom_Ave_20241018.csv"))
...
ggsave(here("outputs","msom_outputs_Viorel covs","Ave_outputs_20241018","detection_preds_msom_Ave_20241018.jpeg"), width = 8,
       height = 10,
       units = "in",
       dpi = 300)
...
b <- b +
  ...
  annotate(geom="text", x=2.8, y=0.8, label="Ave",
           color="aquamarine4")

print(b)

ggsave(here("outputs","msom_outputs_Viorel covs","Ave_outputs_20241018","Occ_Ave_precipitation_20241018.jpeg"), width = 5,
       height = 4,
       units = "in",
       dpi = 300)
...
for (i in 1:length(spp)) {
  ...
  b <- b + geom_line(data=plot.dat1, aes(x=temp.pred, y=mean.psi), 
                     color = col) +
    labs(title = "Ave species occupancy probability",
         x =paste0("low", strrep(" ", 40), "Mean temperature (scaled)", strrep(" ", 40), "high"), y = "Occupancy probability")
  
}

b <- b +
  theme(plot.margin = unit(c(1,3,1,1), "lines")) +
  annotate(geom="text", x=1.9, y=0.8, label="Ave",
           color="aquamarine4")

print(b)

ggsave(here("outputs","msom_outputs_Viorel covs","Ave_outputs_20241018","Occ_Ave_temperature_20241018.jpeg"), width = 5,
       height = 4,
       units = "in",
       dpi = 300)
...
pdf(here("outputs","msom_outputs_Viorel covs","Ave_outputs_20241018","occupancy_plots_by_temp.pdf"), width = 14, height = 40)
...
b <- b +
  theme(plot.margin = unit(c(1,3,1,1), "lines")) +
  annotate(geom="text", x=1.2, y=0.8, label="Ave",
           color="aquamarine4")

print(b)

ggsave(here("outputs","msom_outputs_Viorel covs","Ave_outputs_20241018","Occ_Ave_forestcover_20241018.jpeg"), width = 5,
       height = 4,
       units = "in",
       dpi = 300)
...
b <- b +
  theme(plot.margin = unit(c(1,3,1,1), "lines")) +
  annotate(geom="text", x=2.4, y=0.8, label="Ave",
           color="aquamarine4")

print(b)

ggsave(here("outputs","msom_outputs_Viorel covs","Ave_outputs_20241018","Occ_Ave_humanimpact_20241018.jpeg"), width = 5,
       height = 4,
       units = "in",
       dpi = 300)
...
b <- b +
  theme(plot.margin = unit(c(1,3,1,1), "lines")) +
  annotate(geom="text", x=2.7, y=0.8, label="Ave",
           color="aquamarine4")

print(b)

ggsave(here("outputs","msom_outputs_Viorel covs","Ave_outputs_20241018","Occ_Ave_patchdens_20241018.jpeg"), width = 5,
       height = 4,
       units = "in",
       dpi = 300)
...
ggsave(here("outputs","msom_outputs_Viorel covs","Ave_outputs_20241018","Occ_Ave_edgedens_20241018.jpeg"), width = 5,
       height = 4,
       units = "in",
       dpi = 300)
...
b <- b +
  theme(plot.margin = unit(c(1,3,1,1), "lines")) +
  annotate(geom="text", x=2.1, y=0.8, label="Ave",
           color="aquamarine4")

print(b)

ggsave(here("outputs","msom_outputs_Viorel covs","Ave_outputs_20241018","Occ_Ave_riverOrigin_20241018.jpeg"), width = 5,
       height = 4,
       units = "in",
       dpi = 300)
...
ggsave(here("outputs","msom_outputs_Viorel covs","Ave_outputs_20241018","MSOM_Covariates_Ave_20241018.jpeg"), width = 5,
       height = 2,
       units = "in",
       dpi = 300)
...
spp_df <- data.frame(
  species = paste0("sp", 1:89),
  latin_name = spp
)
beta_long <- left_join(beta_long, spp_df, by = "species") %>% 
  mutate(species = latin_name) %>%
  select(-latin_name)
write.csv(beta_long, here("outputs","msom_outputs_Viorel covs","Ave_outputs_20241018","envCov_perSP_table_msom_Ave.csv"))


save(list = ls(), file = here("data","Rdata files","msom_Ave_20241018_Vioreldata.Rdata"))
